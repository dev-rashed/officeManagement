                ...
                <div>
                    ...
                    <div class="flex space-x-3">
                        ...
                        <label for="featured_image" class="flex items-center justify-center px-4 py-2 border border-dotted border-gray-300 rounded-md text-gray-500 hover:border-indigo-500 hover:text-indigo-600 cursor-pointer">
                            @if(old('featured_image') || ($course && $course->featured_image))
                                <img src="{{ old('featured_image') ?? Storage::disk('public')->url($course->featured_image) }}" alt="Preview" class="w-16 h-16 object-cover rounded">
                            @else
                                Upload Image
                            @endif
                        </label>
