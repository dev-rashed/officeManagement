...
@section('content')
<x-flux::page-header title="Course Categories">
    <x-flux::toolbar>
        <x-flux::button href="{{ route('admin.course-categories.create') }}" variant="primary">
            Add Category
        </x-flux::toolbar>
</x-flux::page-header>
...
<div class="space-y-4">
    <div class="p-4 bg-white rounded-lg shadow">
        <table class="w-full" id="courseCategoriesTable">
            <thead>
                <tr class="border-b">
