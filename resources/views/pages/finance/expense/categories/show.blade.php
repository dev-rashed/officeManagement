    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center gap-3">
                <a href="{{ route('expense.categories') }}" class="rounded-lg border border-zinc-700 p-1.5 text-zinc-400 transition hover:bg-zinc-800 hover:text-white">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-zinc-500">{{ __('Expense category overview and analytics') }}</p>
                </div>
            </div>
        </div>
        ...
        {{-- Monthly chart --}}
        <div class="rounded-2xl border border-zinc-800 bg-zinc-900 p-5">
            <h2 class="mb-4 text-sm font-semibold text-zinc-300">{{ __('Monthly Expense — Last 12 Months') }}</h2>
            ...
            @forelse($recentEntries as $entry)
                <div class="flex items-center justify-between border-b border-zinc-800/60 px-5 py-3 last:border-b-0">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('expense.show', $entry) }}" class="rounded-lg bg-zinc-800 px-3 py-1 text-xs font-medium text-zinc-300 transition hover:bg-zinc-700">View</a>
                    </div>
                </div>
            @empty
