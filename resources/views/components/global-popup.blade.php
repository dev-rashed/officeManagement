<div
    id="global-popup"
    class="pointer-events-none fixed inset-0 z-[120] hidden items-center justify-center overflow-y-auto p-4 sm:p-6"
    aria-hidden="true"
>
    <div class="absolute inset-0 bg-black/55 backdrop-blur-sm transition-opacity duration-200" data-popup-overlay></div>

    <div
        class="relative my-auto w-full max-w-sm overflow-hidden rounded-lg border border-white/10 bg-white/95 p-5 text-center text-zinc-900 shadow-[0_24px_80px_rgba(0,0,0,0.32)] transition duration-200 dark:border-white/8 dark:bg-zinc-900/95 dark:text-white sm:p-7"
        role="dialog"
        aria-modal="true"
    ...
    >
        ...
        <h2 id="global-popup-title" class="mt-5 text-xl font-semibold tracking-tight sm:text-[1.75rem]" data-popup-title>
        ...
        <div class="mt-7 grid gap-3 sm:flex sm:items-center sm:justify-center" data-popup-actions>
            <button
                type="button"
                class="hidden min-h-11 rounded-lg bg-zinc-100 px-5 py-3 text-sm font-medium text-zinc-700 transition hover:bg-zinc-200 dark:bg-white/8 dark:text-zinc-200 dark:hover:bg-white/12 sm:min-w-32"
            ...
            <button
                type="button"
                class="min-h-11 rounded-lg bg-zinc-900 px-6 py-3 text-sm font-medium text-white transition hover:bg-zinc-700 dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-200 sm:min-w-40"
                data-popup-primary
            >
                {{ __('Close') }}
            </button>
